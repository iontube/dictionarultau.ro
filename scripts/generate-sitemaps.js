...
/**
 * Generate WordPress-style sitemaps for dictionarultau.ro
 * Creates:
...
const SITE_URL = 'https://dictionarultau.ro';
...
function generatePostSitemap() {
  ...
  for (const article of articles) {
    ...
    const imageFullPath = path.join(DIST_DIR, imagePath);
